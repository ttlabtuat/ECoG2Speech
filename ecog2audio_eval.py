...
#    exit()
    ...
    ecog_data, audio_feat_data, tokens, tokenizer, audio_feat_padding = preprocessingX(args.data_csv, conf, car, ch_sum, part_sum, band_sum, zscore_hayashi, args.model, meldump)
